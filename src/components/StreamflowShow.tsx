...
import {
  hideAnimation,
  onHover,
} from "./projectsAnimations/StreamflowAnimation";

const StreamflowShow = () => {
  ...
  return (
    <div>
      ...
      >
        ...
        />
        <img
          className="w-full max-w-[600px] md:max-w-[600px] cursor-pointer hover:touch-pan-right"
          src={streamflowDash}
          alt=""
        />
        <img
